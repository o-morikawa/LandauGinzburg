...
public:
  ...
  /**
   * \fn     double nr_method_core (Scalar &scli; const VectorXi k, const VectorXd lambda, const int num_nrsol, const int LOOP)
   * \brief  Newton--Raphson method by parallel computing (openmp)
   * \param  scli      A solution overwritten
   * \param  k         Power in superpotential
   * \param  lambda    Coupling
   * \param  num_nrsol Number of "convergent" trials of NR method
   * \param  LOOP      Maximum number of iteration
   ...
   *         because of divergence
   */
  double nr_method_core (Scalar &scli,
  ...
  /**
   * \fn     double nr_method_omp (const VectorXi k, const VectorXd lambda, const int num_nrsol, const int LOOP)
   * \brief  Newton--Raphson method by parallel computing (openmp)
   * \param  k         Power in superpotential
   * \param  lambda    Coupling
   * \param  num_nrsol Number of "convergent" trials of NR method
   ...
   *         because of divergence
   */
  double nr_method_omp (const VectorXi k, const VectorXd lambda,
					const int num_nrsol, const int LOOP,
					const SuperPotentialType t
					= SuperPotentialType::AlgebraA);
